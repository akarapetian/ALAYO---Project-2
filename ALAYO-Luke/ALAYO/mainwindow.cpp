...
const string MLB_INFORMATION_IF = "C:/Users/Oscar/Desktop/ALAYO-Luke/ALAYO/inputMLBInformation.csv";
// original Distances const
const string DISTANCES_IF = "C:/Users/Oscar/Desktop/ALAYO-Luke/ALAYO/inputDistance.csv";
// written to MLB Information const
const string MODIFIED_MLB_INFORMATION_IF = "C:/Users/Oscar/Desktop/ALAYO-Luke/ALAYO/modifiedMLBInformation.csv";
// written to Distances const
const string MODIFIED_DISTANCES_IF = "C:/Users/Oscar/Desktop/ALAYO-Luke/ALAYO/modifiedDistances.csv";
...
// if file = 0 - reads from expansion files
// if file = 1 - reads from original or normal
// if file = 2 - reads from original (used for reinitializing);
void MainWindow::readFromFiles(int file)
{
    if(file == 0)
    {
    ...
    else
    {
        ...
        ifstream test;
        test.open(MODIFIED_MLB_INFORMATION_IF);
        ...
        if(original)
        {
            csvFile1.open(MLB_INFORMATION_IF);
        }
        else
        {
            csvFile1.open(MODIFIED_MLB_INFORMATION_IF);
        }
        ...
        if(original)
        {
            csvFile2.open(DISTANCES_IF);
        }
        else
        {
            csvFile2.open(MODIFIED_DISTANCES_IF);
        }
