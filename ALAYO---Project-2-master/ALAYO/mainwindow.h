...
private slots:
    ...
    void on_availibleStadiumsStackedWidget_itemChanged(QListWidgetItem *item);

    void on_selectedStadiumStackedWidget_currentItemChanged(QListWidgetItem *current, QListWidgetItem *previous);

    void on_selectedStadiumStackedWidget_itemChanged(QListWidgetItem *item);
